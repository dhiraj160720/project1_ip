...
{  
  ...
  $sql = "insert into dbms (question_title,option1,option2,option3,option4,right_ans)  values ('$question_title','$option1','$option2','$option3','$option4','$right_ans')";

  $run = mysqli_query($conn, $sql) or die(mysqli_error());

   if ($run) {
    echo "<script>alert('Question Added Successfully!')</script>";
    header("Location: admin_dbms.php");
